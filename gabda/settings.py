# Django settings for gabda project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'gabda',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '3^%-680jn=2a%*p+_i)dp$1qstq6^j=cym6-aec1qdm$@1t^s_'
...
WSGI_APPLICATION = 'gabda.wsgi.application'
